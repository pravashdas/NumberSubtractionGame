...
3. Give the permission to the `magic.py` to the script by using 'chmod +x NumberSubtractionGame'.
4. Run the `magic.py` script using a Python interpreter.
